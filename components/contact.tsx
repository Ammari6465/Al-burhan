...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-shell bg-[rgba(255,255,255,0.015)] py-20 pb-24 sm:py-24 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-12 max-w-3xl text-center sm:mb-16">
          <p className="section-kicker mb-4 text-[11px] font-semibold text-[#C0392B]">Contact</p>
        ...
        <div className="mx-auto max-w-2xl space-y-5">
            ...
            <div className="mt-6 space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:alburhanind.drives@gmail.com" className="mt-1 text-sm leading-6 text-white/55 transition hover:text-white">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+919819036787" className="mt-1 text-sm leading-6 text-white/55 transition hover:text-white">
                    +91 98190 36787
                  </a>
                </div>
              </div>
          ...
          <div className="overflow-hidden rounded-[2rem] border border-white/8 bg-white/4 shadow-[0_18px_55px_rgba(10,24,38,0.08)]">
            <iframe
